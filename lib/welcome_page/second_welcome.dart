import 'package:firstapp/welcome_page/third_welcome.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(WelcomePageSecond());
}

// StatelessWidgetクラスという親クラスをMyAppに継承している
class WelcomePageSecond extends StatelessWidget {
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Container(
                      child: Text(
                        'トークン収益で選手獲得や育成の強化、ファンの皆さまとのより良い関係づくりへ！',
                        style: TextStyle(
                          fontSize: 15,
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
